    ...
    <LegalLayout title="Privacy Policy">
      ...
      <section>
        ...
        <ul className="mt-3 list-inside list-disc space-y-2">
          <li>
            <strong className="text-white">Website usage data</strong> — such as
            your IP address, browser type, device information, and pages visited.
            Some of this is collected automatically when you use our site, including
            through third-party services described below.
          </li>
          <li>
          ...
          <li>
            ...
            — if you contact us by WhatsApp, email, phone, or social media, we
            receive the information you choose to send (for example your name,
            phone number, email address, and details about the tattoo or treatment
      ...
      <section>
        ...
        <ul className="mt-3 list-inside list-disc space-y-2">
          <li>
            <strong className="text-white">Legitimate interests</strong> — to run
            our business, respond to enquiries, and maintain our website. We balance
            this against your rights and only use data in ways you would reasonably
            expect.
          </li>
          <li>
          ...
          <li>
            ...
            necessary to provide tattoo or aesthetic services you have asked us
            about or booked.
          </li>
          <li>
            <strong className="text-white">Legal obligation</strong> — where we
            must keep records or comply with applicable law.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p className="mt-3">
          ...
          communicate with clients. These providers may process personal data on
          our behalf or as independent controllers:
        </p>
        <ul className="mt-3 list-inside list-disc space-y-2">
          <li>
            ...
            embedded Google Map if you accept cookies. Google&apos;s privacy policy
            is available at{' '}
            <a
          ...
          <li>
            <strong className="text-white">Meta (WhatsApp)</strong> — if you click
            our WhatsApp booking links, your conversation is handled by WhatsApp/Meta
            under their own terms and privacy policy.
          </li>
          <li>
            <strong className="text-white">Social media platforms</strong> — links
            to Facebook, Instagram, and TikTok are provided for your convenience.
        ...
        <p className="mt-3">
          ...
          necessary to provide our services, operate our website, or comply with
          the law.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="mt-3">
          ...
          data outside the UK. Where this happens, we rely on appropriate
          safeguards such as the UK International Data Transfer Agreement or
          provider contractual commitments, as applicable.
        </p>
      </section>
      ...
      <section>
        ...
        <ul className="mt-3 list-inside list-disc space-y-2">
          <li>
            <strong className="text-white">Enquiry and booking records</strong> —
            kept for as long as needed to manage your appointment and for up to 6
            years afterwards for business and legal record-keeping purposes.
          </li>
          <li>
          ...
          <li>
            <strong className="text-white">Website server logs</strong> — retained
            by our hosting and content providers according to their own retention
            schedules.
          </li>
        </ul>
      </section>
